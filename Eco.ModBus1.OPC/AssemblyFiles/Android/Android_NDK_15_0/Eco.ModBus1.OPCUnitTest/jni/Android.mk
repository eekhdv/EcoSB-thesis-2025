...
########################
# prepare Eco.ModBus1.OPC
include $(CLEAR_VARS)
LOCAL_MODULE    := libF37B74AD45824C1098981A99C35C9FC5
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../BuildFiles/Android/$(TARGET_ARCH_ABI)/StaticRelease/libF37B74AD45824C1098981A99C35C9FC5.a 
include $(PREBUILT_STATIC_LIBRARY)
########################

#
# EcoModBus1OPCUnitTest
#
include $(CLEAR_VARS)
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../UnitTestFiles/SourceFiles/EcoModBus1OPC.c

ifeq ($(TARGET_LINK),0)

LOCAL_MODULE := EcoModBus1OPCUnitTest
...
LOCAL_STATIC_LIBRARIES := 00000000000000000000000000000100 00000000000000000000000042757331 0000000000000000000000004D656D31 00000000000000000000000046534D31 F37B74AD45824C1098981A99C35C9FC5
