...
########################
# prepare Eco.ModBus1.SL
include $(CLEAR_VARS)
LOCAL_MODULE    := libDA26D759A46F405F9977CB5AA9153876
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../BuildFiles/Android/$(TARGET_ARCH_ABI)/StaticRelease/libDA26D759A46F405F9977CB5AA9153876.a 
include $(PREBUILT_STATIC_LIBRARY)
########################

#
# EcoModBus1SLUnitTest
#
include $(CLEAR_VARS)
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../UnitTestFiles/SourceFiles/EcoModBus1SL.c

ifeq ($(TARGET_LINK),0)

LOCAL_MODULE := EcoModBus1SLUnitTest
...
LOCAL_STATIC_LIBRARIES := 00000000000000000000000000000100 00000000000000000000000042757331 0000000000000000000000004D656D31 00000000000000000000000046534D31 DA26D759A46F405F9977CB5AA9153876
