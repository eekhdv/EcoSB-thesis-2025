...
#define CI_INFO ""
#define BROM_FILE_HEAD_SIZE		(sizeof(ECO_BOOT0_FILE_HEAD_t) & 0x00FFFFF)
...
const ECO_BOOT0_FILE_HEAD_t  BT0_head = {
	{
		/* jump_instruction*/
		JUMP_INSTRUCTION,
		ECO_BROM_BOOT0_MAGIC,
		ECO_BROM_STAMP_VALUE,
		0x4000,
		sizeof(ECO_BOOT_FILE_HEAD_t),
		ECO_BROM_BOOT_PUB_HEAD_VERSION,
		ECO_BROM_CONFIG_BOOT0_RET_ADDR,
		ECO_BROM_CONFIG_BOOT0_RUN_ADDR,
		0,
		{
