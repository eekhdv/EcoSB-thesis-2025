...
typedef struct ECO_UART_CONFIG_DESCRIPTOR {
    char_t*         devName;   /* The name of the device. For example, COM1 through COM9 */
    uint16_t        devNameLen; /* The max length of the device name*/
...
typedef struct IEcoUART1LinuxConfigVTbl {
    ...
    /* IEcoUnknown */
    int16_t (*QueryInterface)(/* in */ struct IEcoUART1LinuxConfig* me, /* in */ const UGUID* riid, /* out */ void **ppv);
    uint32_t (*AddRef)(/* in */ struct IEcoUART1LinuxConfig* me);
    uint32_t (*Release)(/* in */ struct IEcoUART1LinuxConfig* me);
