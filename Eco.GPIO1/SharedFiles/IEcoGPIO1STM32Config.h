...
typedef struct IEcoGPIO1STM32ConfigVTbl {
    ...
    /* IEcoUnknown */
    int16_t (ECOCALLMETHOD *QueryInterface)(/* in */ struct IEcoGPIO1STM32Config* me, /* in */ const UGUID* riid, /* out */ void **ppv);
    uint32_t (ECOCALLMETHOD *AddRef)(/* in */ struct IEcoGPIO1STM32Config* me);
    uint32_t (ECOCALLMETHOD *Release)(/* in */ struct IEcoGPIO1STM32Config* me);

    /* IEcoGPIO1STM32Config */
    int16_t (ECOCALLMETHOD *set_ConfigDescriptor)(/* in */ struct IEcoGPIO1STM32Config* me, /* in */ uint8_t PortNumber, /* in */ GPIO_CONFIG_DESCRIPTOR* config);
    GPIO_CONFIG_DESCRIPTOR* (ECOCALLMETHOD *get_ConfigDescriptor)(/* in */ struct IEcoGPIO1STM32Config* me, /* in */ uint8_t PortNumber);
    int16_t (ECOCALLMETHOD *set_LogicalPinNumber)(/* in */ struct IEcoGPIO1STM32Config* me, /* in */ uint8_t LogicalPinNumber, /* in */ uint8_t PortNumber, /* in */ uint16_t PinNumber);
