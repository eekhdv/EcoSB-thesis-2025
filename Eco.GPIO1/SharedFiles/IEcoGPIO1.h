...
typedef struct IEcoGPIO1* IEcoGPIO1Ptr_t;

typedef struct IEcoGPIO1VTbl {

    /* IEcoUnknown */
    int16_t (ECOCALLMETHOD *QueryInterface)(/* in */ IEcoGPIO1Ptr_t me, /* in */ const UGUID* riid, /* out */ voidptr_t* ppv);
    uint32_t (ECOCALLMETHOD *AddRef)(/* in */ IEcoGPIO1Ptr_t me);
    uint32_t (ECOCALLMETHOD *Release)(/* in */ IEcoGPIO1Ptr_t me);

    /* IEcoGPIO1 */
    int16_t (ECOCALLMETHOD *set_Mode)(/* in */ IEcoGPIO1Ptr_t me, /* in */ uint16_t LogicalPinNumber, /* in */ uint8_t mode);
    int16_t (ECOCALLMETHOD *set_Data)(/* in */ IEcoGPIO1Ptr_t me, /* in */ uint16_t LogicalPinNumber, /* in */ uint8_t Value);
    int16_t (ECOCALLMETHOD *get_Data)(/* in */ IEcoGPIO1Ptr_t me, /* in */ uint16_t LogicalPinNumber, /* in | out */ uint8_t *pValue);
